...
class RemoteViews:
    ...
    def delete(self):
        ...
        self.a.c.send_msg({"method": "deleteRemoteLayout", "params": {"rid": self.rid}})
    ...
    def setProgress(self, id, progress, max):
        ...
        self.c.send_msg({"method": "setRemoteProgressBar", "params": {"rid": self.rid, "id": id, "max": max, "progress": progress}})
    ...
    def setPadding(self, id, left, top, right, bottom):
        ...
        self.c.send_msg({"method": "setRemotePadding", "params": {"rid": self.rid, "id": id, "left": left, "top": top, "right" : right, "bottom": bottom}})
